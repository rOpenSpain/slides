...
## mapSpain <img src="https://ropenspain.github.io/mapSpain/logo.png" alt="mapSpain-logo" height="70" style="margin-top: -10px;vertical-align: middle;">
...
tile <- esp_getTiles(galicia, "PNOA", bbox_expand = .2,
                     zoommin = 1)

ggplot(galicia) +
  layer_spatraster(data=tile) +
